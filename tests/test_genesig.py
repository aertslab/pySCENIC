...
def test_init1():
    gs1 = GeneSignature(name="test1", gene2weight=['TP53', 'SOX4'], nomenclature="HGNC")
    assert 'TP53' in gs1
    assert 'SOX4' in gs1
...
def test_init2():
    gs1 = GeneSignature(name="test1", gene2weight=[('TP53', 0.5), ('SOX4', 0.75)], nomenclature="HGNC")
    assert 'TP53' in gs1
    assert 'SOX4' in gs1
    assert gs1.name == 'test1'
    assert gs1.nomenclature == 'HGNC'
...
def test_union1():
    gs1 = GeneSignature(name="test1", gene2weight=['TP53', 'SOX4'], nomenclature="HGNC")
    gs2 = GeneSignature(name="test1", gene2weight=['TP53', 'SOX2'], nomenclature="HGNC")
    gsu = gs1.union(gs2)
    assert 'TP53' in gsu
    assert 'SOX4' in gsu
    assert 'SOX2' in gsu
...
def test_union2():
    gs1 = GeneSignature(name="test1", gene2weight=['TP53', 'SOX4'], nomenclature="HGNC")
    gs2 = GeneSignature(name="test1", gene2weight=['Tp53', 'Sox4'], nomenclature="MGI")
...
def test_union3():
    ...
    gs2 = GeneSignature(name="test1", gene2weight={'TP53': 0.3, 'SOX2': 0.60}, nomenclature="HGNC")
    gsu = gs1.union(gs2)
    assert 'TP53' in gsu
